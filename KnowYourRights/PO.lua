...
local contentTitle = {"Overview", "Procedure", "Rights and Obligations"}
...
local function onRowTouch( event )
  ...
  composer.gotoScene( "PO_Data" , options )
end
...
function scene:create( event )
	...
	-- create some text
	local title = display.newText( "Rights When Pulled Over", display.contentCenterX, display.contentHeight*0.05, "Lucida Sans Unicode", 18 )
